...
class CircDobList
{
	...
	int quantity;
	int ordered; //-1: new elements will be inserted at the beginning. NOT IS WORKING BUT FOR NOW I DON'T CARE
				 //0: new elements will be inserted at the end
				 //1: increasing order 
	
	public:
		CircDobList(bool ordered = 1) { header = pt = 0; quantity = 0; this->ordered = ordered; }
		int add(T newest);
		int remove(T &trash);
